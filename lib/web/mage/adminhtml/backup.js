    ...
    AdminBackup.prototype = {
        ...
        backupConfig: {
            'backup-options': {
                 ...
                 */
                content: function () {
                    return document.getElementById('backup-options-templates').textContent;
                },
            ...
            'rollback-warning': {
                 ...
                 */
                content: function () {
                    return document.getElementById('rollback-warning-templates').textContent;
                },
            ...
            'rollback-request-password': {
                 ...
                 */
                content: function () {
                    return document.getElementById('rollback-request-password-templates').textContent;
                },
