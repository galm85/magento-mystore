...
define([
    ...
    $.widget('mage.validation', $.mage.validation, {
        options: {
            messagesId: 'messages',
            forceIgnore: '',
            ignore: ':disabled, .ignore-validate, .no-display.templates, ' +
                ':disabled input, .ignore-validate input, .no-display.templates input, ' +
                ':disabled select, .ignore-validate select, .no-display.templates select, ' +
                ':disabled textarea, .ignore-validate textarea, .no-display.templates textarea',
            errorElement: 'label',
