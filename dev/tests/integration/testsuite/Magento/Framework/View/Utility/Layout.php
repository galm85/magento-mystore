...
class Layout
{
    ...
    /**
     * Retrieve new frontend update model instance with XML data from a fixture file
     *
    ...
    /**
     * Retrieve new frontend model instance with frontend updates from a fixture file
     *
     * @param string|array $layoutUpdatesFile
     * @param array $args
    ...
    /**
     * Retrieve object that will be used for frontend instantiation
     *
     * @return array
     */
