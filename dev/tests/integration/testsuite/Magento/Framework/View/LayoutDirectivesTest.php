<?php
/**
 * Set of tests of frontend directives handling behavior
 *
...
class LayoutDirectivesTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Prepare a frontend model with pre-loaded fixture of an update XML
     *
     ...
     * 5) when entire frontend is read, all scheduled operations are executed in the same order as declared
    ...
    /**
     * Invoke getBlock() while frontend is being generated
     *
