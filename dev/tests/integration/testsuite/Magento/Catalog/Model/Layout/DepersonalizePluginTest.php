...
class DepersonalizePluginTest extends TestCase
{
    ...
    public function afterGenerateElementsDataProvider(): array
    {
        return [
            'cacheable' => [
                'frontend' => INTEGRATION_TESTS_DIR . '/testsuite/Magento/Framework/View/_files/frontend/cacheable.xml',
                'expectedResult' => [],
            ],
            'nonCacheable' => [
                'frontend' => INTEGRATION_TESTS_DIR . '/testsuite/Magento/Framework/View/_files/frontend/non_cacheable.xml',
                'expectedResult' => ['some_data' => 1],
            ],
            'nonCacheableBlockWithoutReference' => [
                'frontend' => INTEGRATION_TESTS_DIR
                    . '/testsuite/Magento/Framework/View/_files/frontend/non_cacheable_block_with_missing_refference.xml',
                'expectedResult' => [],
            ],
            'nonCacheableBlockWithExistedReference' => [
                'frontend' => INTEGRATION_TESTS_DIR
                    . '/testsuite/Magento/Framework/View/_files/frontend/non_cacheable_block_with_declared_reference.xml',
                'expectedResult' => ['some_data' => 1],
            ],
        ];
    }
