...
class DataProviderTest extends TestCase
{
    ...
    /**
     * Check that deprecated custom frontend attribute is hidden.
     *
     * @return void
     */
    public function testOldCustomLayoutInvisible(): void
    {
        //Testing a category without frontend xml
    ...
    /**
     * Check that custom frontend update file attribute is processed correctly.
     *
     * @return void
     */
    ...
    /**
     * Extract custom frontend update file attribute's options from metadata.
     *
     * @param array $meta
     * @return array
     */
    ...
    /**
     * Check if existing category page frontend will remain unaffected by category page frontend default value setting
     *
     * @return void
     */
    ...
    /**
     * Check if category page frontend default value setting will apply to the new category during it's creation
     *
     * @return void
     */
