...
class DataProviderTest extends TestCase
{
    ...
    /**
     * Check that custom frontend date is handled properly.
     *
    ...
    /**
     * Check that proper meta for custom frontend field is returned.
     *
     * @return void
     * @throws \Throwable
     * @magentoDataFixture Magento/Cms/_files/pages_with_layout_xml.php
    ...
    {
        //Testing a page without frontend xml
        ...
        $expectedList = [
            ['label' => 'No update', 'value' => '_no_update_'],
            ['label' => 'Use existing frontend update XML', 'value' => '_existing_'],
