...
class PageTest extends AbstractController
{
    ...
    /**
     * Tests page renders even with unavailable custom page frontend.
     *
    ...
    {
        return [
            'Page with 1column frontend' => ['page-with-1column-frontend'],
            'Page with unavailable frontend' => ['page-with-unavailable-frontend']
        ];
    }
}
