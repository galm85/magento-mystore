...
class PublicCodeTest extends TestCase
{
     ...
     * So all blocks should be @api annotated. This test checks that all blocks declared in frontend files are public
     *
     * @param $layoutFile
    ...
    /**
     * Find all frontend update files in magento modules and themes.
     *
     * @return array
     * @throws Exception
     */
