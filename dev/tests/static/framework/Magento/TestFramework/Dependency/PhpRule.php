...
/**
 * Rule to check the dependencies between modules based on references, getUrl and frontend blocks
 */
class PhpRule implements RuleInterface
{
    ...
    {
        if (!in_array($fileType, ['php', 'templates', 'fixture'])) {
            return [];
        }
